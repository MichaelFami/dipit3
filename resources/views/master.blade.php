        ...
        <div class="container">
            <div class="row w-100 no-gutters d-lg-flex d-flex flex-wrap justify-content-between">
                <a class="navbar-brand col-lg-3 col-7 py-lg-3 order-lg-1 order-2 float-left d-block" href="/">
                    <img id="dipItLogo" src="images/logo_orange.png" class="img-fluid">
                </a>
                    ...
                    <ul class="navbar-nav justify-content-between ml-auto w-75">
                        <li class="nav-item dropdown">
                            <li class="nav-item active">
                                <a class="nav-link" href="/courseCatalog">Home<span class="sr-only">(current)</span></a>
                            </li>
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="/applicationForm">About Dip It</a>
                            </div>
                        </li>
                        <span class="navbar-slash">/</span>
                        <li class="nav-item">

                            <a class="nav-link" href="/fullStack">Press</a>
                        </li>
                        <span class="navbar-slash">/</span>
                        <li class="nav-item">
                            <a class="nav-link" href="#">About Dip It</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container">
                <div class="row justify-content-between w-100">
                    ...
                    <div class="col-md-3 text-white">
                        <p>(956) 458-6513
                            <br>
                            <br> 106 international Bulevard, Suite 1-C
                            <br> MISSION, TX 78572
                        </p>
                        <hr>

                        <a class="text-white" href="#">WORK AT DIP IT</a>
                    </div>
                </div>
                <div class="row text-center">
                    <div class="col">
                        ...
                        <br>
                        <span class="text-white">&copy; 2018 DIP It. All Rights Reserved</span>
                    </div>
